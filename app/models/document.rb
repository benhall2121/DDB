class Document < ActiveRecord::Base
  ...
  has_attached_file :doc, :whiny => false, :styles => { :icon => ["50x50>", :jpg], :small => ["128x128>", :jpg], :medium => ["300x300>", :jpg], :large => ["1224x1584>", :jpg] }, #:styles      => {:icon => "50x50#", :thumb=> "100x100#", :small  => "190x190#", :large => "500x500>" },
